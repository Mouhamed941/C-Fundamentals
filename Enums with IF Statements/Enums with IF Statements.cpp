// Enums with IF Statements.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
void ChoseScreenColor()
{
    cout << "**********************" << endl;
    cout << "Please Enter The Number of Your Color :" << endl;
    cout << "(1) Red\n";
    cout << "(2) Blue\n";
    cout << "(3) Green\n";
    cout << "(4) Yellow\n";
